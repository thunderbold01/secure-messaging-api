...
class Mensagem(models.Model):
    ...
    ALGORITMOS = [
        ...
        ('HYBRID-RSA-AES-256-CBC', 'Híbrido RSA+AES-256'),  # ADICIONAR ESTE
    ]
    ...
    algoritmo = models.CharField(max_length=50, choices=ALGORITMOS, default='HYBRID-RSA-AES-256-CBC')  # ALTERAR DEFAULT
    conteudo_cifrado = models.BinaryField()
    metadados_cifrados = models.BinaryField(null=True, blank=True)
    
    hash_algoritmo = models.CharField(max_length=10, choices=HASHES, default='SHA-256')
    ...
    # ⬇️⬇️⬇️ ADICIONAR ESTE CAMPO AQUI ⬇️⬇️⬇️
    texto_original = models.TextField(null=True, blank=True)  # Para o remetente visualizar
